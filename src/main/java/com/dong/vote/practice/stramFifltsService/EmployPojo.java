package com.dong.vote.practice.stramFifltsService;
...
class TestService {
  public static void main(String[] args) {
    ...
    // start -- 比较两个实例中指定元素，返回大的
    List<EmployPojo> employPojos1 = Lists.newArrayList();
    employPojos1.stream().max(Comparator.comparing(EmployPojo::getAge)).get();
    // end -- 比较两个实例中指定元素，返回大的
    ...
    bigDecimal.movePointLeft(2).setScale(1, RoundingMode.HALF_UP).doubleValue();
    // end -- 保留小数
