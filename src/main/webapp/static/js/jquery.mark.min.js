...
!function (e, t, n) {
    "function" == typeof define && define.amd ? define(["jquery"], function (r) {
        return e(t, n, r)
    }) : "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = e(t, n, require("jquery")) : e(t, n, jQuery)
}(function (e, t, n) {
    var r = function () {
        function n(t) {
            _classCallCheck(this, n), this.ctx = t, this.ie = !1;
        ...
        return _createClass(n, [{
            key: "log", value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "debug", n = this.opt.log;
            ...
            key: "createSynonymsRegExp", value: function (e) {
                var t = this.opt.synonyms, n = this.opt.caseSensitive ? "" : "i", r = this.opt.ignoreJoiners || this.opt.ignorePunctuation.length ? "\0" : "";
                for (var i in t)if (t.hasOwnProperty(i)) {
                    var o = t[i], a = "disabled" !== this.opt.wildcards ? this.setupWildcardsRegExp(i) : this.escapeStr(i),
                        s = "disabled" !== this.opt.wildcards ? this.setupWildcardsRegExp(o) : this.escapeStr(o);
                    "" !== a && "" !== s && (e = e.replace(new RegExp("(" + a + "|" + s + ")", "gm" + n), r + "(" + this.processSynomyms(a) + "|" + this.processSynomyms(s) + ")" + r))
                }
                return e
            }
        }, {
            ...
            key: "checkWhitespaceRanges", value: function (e, t, n) {
                ...
                return s = s > o ? o : s, (r = s + parseInt(e.length, 10)) > o && (r = o, this.log("End range automatically set to the max value of " + o)), s < 0 || r - s < 0 || s > o || r > o ? (i = !1, this.log("Invalid range: " + JSON.stringify(e)), this.opt.noMatch(e)) : "" === n.substring(s, r).replace(/\s+/g, "") && (i = !1, this.log("Skipping whitespace only range: " + JSON.stringify(e)), this.opt.noMatch(e)), {
                    start: s,
                    end: r,
                    valid: i
                }
            ...
            key: "wrapRangeInTextNode", value: function (e, n, r) {
                var i = this.opt.element ? this.opt.element : "mark", o = e.splitText(n), a = o.splitText(r - n), s = t.createElement(i);
                return s.setAttribute("data-markjs", "true"), this.opt.className && s.setAttribute("class", this.opt.className), s.textContent = o.textContent, o.parentNode.replaceChild(s, o), a
            }
        }, {
            key: "wrapRangeInMappedTextNode", value: function (e, t, n, r, i) {
                ...
                e.nodes.every(function (a, s) {
                    ...
                    if (void 0 === c || c.start > t) {
                        ...
                        var u = t - a.start, l = (n > a.end ? a.end : n) - a.start, h = e.value.substr(0, a.start), f = e.value.substr(l + a.start);
            ...
            key: "unwrapMatches", value: function (e) {
                ...
                n.replaceChild(r, e), this.ie ? this.normalizeTextNode(n) : n.normalize()
            }
        }, {
            ...
            key: "mark", value: function (e, t) {
                var n = this;
                this.opt = t;
                var r = 0, i = "wrapMatches", o = this.getSeparatedKeywords("string" == typeof e ? [e] : e), a = o.keywords, s = o.length,
        ...
        function e(t) {
            ...
            _classCallCheck(this, e), this.ctx = t, this.iframes = n, this.exclude = r, this.iframesTimeout = i
        }

        return _createClass(e, [{
            key: "getContexts", value: function () {
                var e = [];
                return (void 0 !== this.ctx && this.ctx ? NodeList.prototype.isPrototypeOf(this.ctx) ? Array.prototype.slice.call(this.ctx) : Array.isArray(this.ctx) ? this.ctx : "string" == typeof this.ctx ? Array.prototype.slice.call(t.querySelectorAll(this.ctx)) : [this.ctx] : []).forEach(function (t) {
            ...
            key: "createIterator", value: function (e, n, r) {
                return t.createNodeIterator(e, n, r, !1)
            }
        }, {
            ...
            key: "getIteratorNode", value: function (e) {
                var t = e.previousNode(), n = void 0;
                return n = null === t ? e.nextNode() : e.nextNode() && e.nextNode(), {prevNode: t, node: n}
            }
        }, {
            ...
            key: "iterateThroughNodes", value: function (e, t, n, r, i) {
                for (var o = this, a = this.createIterator(t, e, r), s = [], c = [], u = void 0, l = void 0; function () {
                ...
                c.forEach(function (e) {
                    n(e)
                }), this.iframes && this.handleOpenIframes(s, e, n, r), i()
            }
        }, {
    ...
    return n.fn.mark = function (e, t) {
        return new r(this.get()).mark(e, t), this
    }, n.fn.markRegExp = function (e, t) {
        return new r(this.get()).markRegExp(e, t), this
    }, n.fn.markRanges = function (e, t) {
        return new r(this.get()).markRanges(e, t), this
    }, n.fn.unmark = function (e) {
        return new r(this.get()).unmark(e), this
    }, n
}, window, document);